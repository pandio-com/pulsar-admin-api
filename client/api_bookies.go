 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param bookie
 * @param optional nil or *BookiesApiUpdateBookieRackInfoOpts - Optional Parameters:
     * @param "Group" (optional.String) -

*/

type BookiesApiUpdateBookieRackInfoOpts struct {
	Group optional.String
}

func (a *BookiesApiService) UpdateBookieRackInfo(ctx context.Context, bookie string, localVarOptionals *BookiesApiUpdateBookieRackInfoOpts) (*http.Response, error) {
	var (
